...
<head>
    ...
    <script>
        ...
        $(function () {
            $.post("${pageContext.request.contextPath}/article/findAll02.do",{},function (data) {
                $("#AllArticle").append(data)
            })
        });
    </script>
</head>
    ...
    <div class="hm-inner">
        ...
        <div class="hm-bbs-info">
            ...
            <div class="search-box l">
                <form action="${pageContext.request.contextPath}/article/search" method="post">
                    <input type="text" class="txt l" placeholder="请输入关键字" name="title">
        ...
        <div class="hm-bbs-main border-lrb clearfix">
            ...
            <div class="list-view l">
                <ul>
                   ...
                   <%-- <li class="clearfix ding">
                        <div class="hm-index-title">
                            <i class="set-to-top">顶</i> <a href="getArticle.do">标题</a>
                        </div>
                        <div class="hm-index-con">非哈佛哈佛哈佛</div>
                        <div class="hm-index-info l">
                            <span class="article-username">晨曦初露</span>
                            <span class="post-time">时间</span>
                        </div>
                        <div class="hm-index-fun r">
                            <span class="icon-like"><i></i>11</span>
                            <span class="icon-talk"><i></i>02</span>
                        </div>
                    </li>
                    <li class="clearfix">
                        <div class="hm-index-title">
                        ...
                        <div class="hm-index-con">匹配，都匹配不到？有次匹配了10分钟，这是为什么？</div>
                        <div class="hm-index-info l">
